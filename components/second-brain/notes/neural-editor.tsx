    ...
    const editor = useEditor({
        ...
        extensions: [
            ...
            Placeholder.configure({
                placeholder: "TYPE '/' FOR NEURAL COMMANDS...",
