...
export const Timeline = ({ data, title = "The Journey", description = "A chronological overview of your habit landscape and progression." }: { data: TimelineEntry[], title?: string, description?: string }) => {
