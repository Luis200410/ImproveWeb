...
export function AppHeroShowcase({ app }: AppHeroShowcaseProps) {
  ...
  return (
    <div className="relative w-full overflow-hidden py-12 sm:py-20">
      
      {/* Background radial aura */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] sm:w-[900px] h-[450px] bg-gradient-to-b from-[#5E5CE6]/25 via-[#30D158]/15 to-transparent blur-[120px] pointer-events-none rounded-full" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* Right Hero Column: Stunning Floating 3D Device Showcase */}
          <div className="lg:col-span-6 flex justify-center relative">
            ...
            >
              ...
              <div className="w-full rounded-[42px] bg-[#050507] border border-white/10 p-4 space-y-4 text-white overflow-hidden relative">
                ...
                {/* The Hero Neon Green Live Card from Figma */}
                ...
                {/* 4 Telemetry Metrics Grid from Figma */}
